...
double ExperiChecks::PositionSpeedMaxConsistancyCheck(Coord * curPosition,
        Coord * curPositionConfidence, Coord * oldPosition,
...
void ExperiChecks::KalmanPositionSpeedConsistancyCheck(Coord * curPosition,
...
double ExperiChecks::KalmanPositionConsistancyCheck(Coord * curPosition,
...
double ExperiChecks::KalmanPositionAccConsistancyCheck(Coord * curPosition,
...
double ExperiChecks::KalmanSpeedConsistancyCheck(Coord * curSpeed,
