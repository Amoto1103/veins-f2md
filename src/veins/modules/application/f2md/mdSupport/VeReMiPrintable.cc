...
void VeReMiPrintable::serializeGroundTruth(BasicSafetyMessage *bsm) {
    ...
    Coord *posc = &bsm->getSenderPosConfidence();
    Coord *spd = &bsm->getSenderSpeed();
    Coord *spdc = &bsm->getSenderSpeedConfidence();
    Coord *hed = &bsm->getSenderHeading();
    Coord *hedc = &bsm->getSenderHeadingConfidence();
    Coord *acl = &bsm->getSenderAccel();
    Coord *aclc = &bsm->getSenderAccelConfidence();
...
void VeReMiPrintable::serializeRawData(Coord*curPosition,
        Coord*curPositionConfidence, Coord*curSpeed, Coord*curSpeedConfidence,
        Coord*curHeading, Coord*curHeadingConfidence, Coord*curAccel,
