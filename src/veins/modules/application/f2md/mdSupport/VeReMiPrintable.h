...
public:
    ...
    void serializeRawData(Coord*curPosition, Coord*curPositionConfidence,
            Coord*curSpeed, Coord*curSpeedConfidence, Coord*curHeading,
            Coord*curHeadingConfidence, Coord*curAccel,
